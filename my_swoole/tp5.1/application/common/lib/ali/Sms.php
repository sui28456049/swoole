...
class Sms {
	...
	public static function getAcsClient() {
		...
		$accessKeyId = "r7Vj8dzlI83b1WGV"; // AccessKeyId

		$accessKeySecret = "5rSKUqOMMNlRjcK85kuL1I7nYdu6RV"; // AccessKeySecret
	...
	public static function sendSms($phone, $code) {
		...
		$request->setSignName("伤心公主");

		// 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
		$request->setTemplateCode("SMS_109465503");
